...
```C
                                      TASK_A                                                                                TASK_B
                                        ...
                                        │                                                                                       │
                       USER_MODE(A)     │      KERNEL_MODE(B)                                               KERNEL_MODE(B)      │       USER_MODE(B)
                                        │                                                                                       │
                ┌─────────────────────┐ │                                                                                       │
                │  previous_function  │ │                                                                                       │
                └──────────┬──────────┘ │                                                                                       │
                                        ...
                                        │                                                                                       │           │         ──┘
                                                                                                     add 0x04 to mepc to avoid  │           │
                                                                                                       triggering ecall again   │   ┌───────▼─────────┐
                                                                                                                                ...
                                                                                                                                │
```
In this example, **mepc** value is saved on stack as it corresponds to **ax_task_wakeup** in **TASK_A context** and **ax_sleep_sleep** in **TASK_B context**. This enables to enter in the exception handler by the **ax_task_wakeup** syscall and returns from exception handler by the **ax_task_sleep** syscall.
