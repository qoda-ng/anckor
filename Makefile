...
# build all kernel components in objects files
	...
	cd lib && $(MAKE) $@
# link all components
	$(LD) $(LDFLAGS) build/strlen.o build/context.o build/start.o build/trap.o build/task_arch.o build/uart.o build/kernel.o build/task.o build/sched.o build/platform.o -o build/kernel.elf
